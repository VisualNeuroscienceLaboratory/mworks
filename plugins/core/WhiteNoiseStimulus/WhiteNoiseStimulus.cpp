...
const std::string WhiteNoiseStimulus::GRATING_TYPE("grating_type");
const std::string WhiteNoiseStimulus::MASK("mask");

const std::string WhiteNoiseStimulus::GRATING_SAMPLE_RATE("grating_sample_rate");
const std::string WhiteNoiseStimulus::INVERTED("inverted");
const std::string WhiteNoiseStimulus::STD_DEV("std_dev");
const std::string WhiteNoiseStimulus::MEAN("mean");

const std::string WhiteNoiseStimulus::CONTRAST("contrast");
const std::string WhiteNoiseStimulus::OPACITY("opacity");

const std::string WhiteNoiseStimulus::DIRECTION("direction");
const std::string WhiteNoiseStimulus::SPATIAL_FREQUENCY("spatial_frequency");
const std::string WhiteNoiseStimulus::TEMPORAL_FREQUENCY("temporal_frequency");
const std::string WhiteNoiseStimulus::STARTING_PHASE("starting_phase");
